...
export default function Lista01() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.titulo}>Lista 01 - Enzo Antônio Ferreira de Araújo =D</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.label}>Exercício 2 - Variáveis com Text</Text>
        <Text>Linguagem: {linguagem} | Ano: {ano}</Text>
      </View>
      <View style={styles.card}>
